...
namespace PostHubServer.Migrations
{
    ...
    [Migration("20241204160910_petittest")]
    partial class petittest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostHubServer.Models.Hub", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PostHubServer.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CommentUser", b =>
                {
                    b.HasOne("PostHubServer.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HubUser", b =>
                {
                    b.HasOne("PostHubServer.Models.Hub", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PostHubServer.Models.Comment", b =>
                {
                    b.HasOne("PostHubServer.Models.Comment", "ParentComment")
                        .WithMany("SubComments")
                        .HasForeignKey("ParentCommentId");

                    b.HasOne("PostHubServer.Models.User", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("PostHubServer.Models.Post", b =>
                {
                    ...
                    b.HasOne("PostHubServer.Models.Comment", "MainComment")
                        .WithOne("MainCommentOf")
                        .HasForeignKey("PostHubServer.Models.Post", "MainCommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
