        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HubUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DownvotesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentUser", x => new { x.DownvotersId, x.DownvotesId });
                    table.ForeignKey(
                        name: "FK_CommentUser_AspNetUsers_DownvotersId",
                        column: x => x.DownvotersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentUser_Comments_DownvotesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentUser1", x => new { x.UpvotersId, x.UpvotesId });
                    table.ForeignKey(
                        name: "FK_CommentUser1_AspNetUsers_UpvotersId",
                        column: x => x.UpvotersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentUser1_Comments_UpvotesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_Comments_MainCommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentUser_DownvotesId",
                table: "CommentUser",
                column: "DownvotesId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentUser1_UpvotesId",
                table: "CommentUser1",
                column: "UpvotesId");
